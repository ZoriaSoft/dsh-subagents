				...
				h("div", { className: "sa-rmain" },
					h("div", { className: "sa-rname" }, role.name,
						off ? h("span", { className: "sa-badge sa-b-off" }, badgeText)
							: h("span", { className: "sa-badge sa-b-" + kind, title: role.route }, badgeText)),
					h("div", { className: "sa-rtool" }, role.tool + (role.tools ? " · " + role.tools.length + " " + t("tools.count") : "")),
			...
			return h("div", { className: "sa-editor" },
				...
				h("div", { className: "sa-field" },
					...
					kind === "cli" ? h("div", { style: { marginTop: 8 } },
						...
						h("div", { className: "sa-hint" }, "cmdc · pi · agy · claude · dsh — görev bu CLI'da koşar.")) : null,
				),
				h("div", { className: "sa-field" },
